...
- Care Home Director
- Facilities Manager
- Procurement or Food Buying Lead

## Email 1: Initial Outreach

Subject: Quick question about food waste at [Facility Name]

```text
Hi [Name],

Quick question: how much time does your team currently spend on:

1. Manual HACCP or food safety logs
...
Would a 20-minute walkthrough be useful this week?
...
Subject: Re: food waste and audit prep
...
The pattern we see in healthcare kitchens is usually one of these:

1. Compliance logs are spread across paper, spreadsheets, and staff memory.
...
## Email 3: Social Proof Angle

Subject: reducing waste without adding admin
...
- Waste recorded by item, reason, and cost
- HACCP and audit evidence kept in one place
- Reorders based on live stock and expiry data

For an 85-bed care home, even an 18% reduction in avoidable food waste can be worth tens of thousands of pounds a year.

Worth a short call to see if the numbers make sense for [Facility Name]?

[Your Name]
```

## Email 4: Low-Commitment Demo Ask

Subject: should I send the walkthrough?

```text
Hi [Name],

If now is not the right time for a call, I can send a short walkthrough instead.
...
Is reducing food waste and compliance admin a current priority for your team, or should I come back to this later in the year?
...
- How are HACCP and temperature records currently captured?
- How is food waste recorded and reviewed?
- Do you know the monthly cost of avoidable food waste?
- How do staff request missing or low-stock items?
- How often do expiry issues create waste?
- Who reviews supplier costs and reorder decisions?
- What would make a 30-day pilot worth continuing?

## Demo Flow

1. Confirm the current workflow and pain.
2. Show compliance records and audit evidence.
3. Show inventory, expiry, and reorder workflows.
4. Show waste records and cost impact.
5. Show reports and exports.
6. Close on one facility pilot.
...
- 50+ targeted outbound emails
- 50+ new prospects added
- 25+ LinkedIn touches
- 8-10% reply rate target
- 3-5 demos booked
- 1+ pilot proposed
- 1 message or landing page improvement from real feedback
