...
- [x] Added recurring compliance task schedules with due/overdue status and automatic next-due roll-forward on completion.

### Verified Locally

- [x] `npm.cmd run test:smoke` passes 21/21 tests.
