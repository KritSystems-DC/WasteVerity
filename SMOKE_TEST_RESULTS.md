...
- Local Docker PostgreSQL container `stocksense-postgres` was reachable on `127.0.0.1:5432`.
...
```text
DATABASE_URL=postgresql://postgres:postgres@127.0.0.1:5432/stocksense?schema=public
```
