  ...
  return (
    <main className="min-h-screen bg-slate-50 px-6 py-12 text-slate-950">
      <section className="mx-auto max-w-6xl">
        <p className="text-sm font-semibold uppercase tracking-wide text-blue-700">WasteVerity features</p>
        <h1 className="mt-3 max-w-3xl text-4xl font-bold">Healthcare food service workflows in one operating system.</h1>
        <p className="mt-4 max-w-3xl text-lg text-slate-600">
          WasteVerity connects compliance, waste, inventory, supplier, and staff workflows so regulated kitchens can work from one source of truth.
        </p>
